<nav class="navbar navbar-toggleable-md navbar-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            @auth
                <li class="nav-item">
                    <a href="" class="nav-link"><i class="material-icons">shopping_basket</i>
                ...
                <li class="nav-item dropdown">
                    <a class="btn btn-secondary btn-sm dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown"
